...
## Habilidades
- Comunicación asertiva en español e inglés (nivel C1).
- Capacidad de adaptación y aprendizaje continuo.
- Trabajo en equipo.
- Responsabilidad, puntualidad y organización.
- Pensamiento analítico y resolución de problemas.
- Conocimientos básicos de programación y sistemas informáticos.
- Atención y servicio al cliente (formación técnica certificada).
